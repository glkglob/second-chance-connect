  ...
  const jobs = [
    {
      ...
      description:
        "Join our team as a warehouse associate. Responsibilities include loading/unloading, inventory management, and order fulfillment. No experience required, we provide training.",
