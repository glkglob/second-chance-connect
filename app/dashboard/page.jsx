...
export default function DashboardPage() {
  const profileSteps = [
    { id: "1", title, description, completed,
    { id: "2", title, description, completed,
    { id: "3", title, description, completed,
    { id: "4", title, description, completed,
    { id: "5", title, description, completed,
  ]
